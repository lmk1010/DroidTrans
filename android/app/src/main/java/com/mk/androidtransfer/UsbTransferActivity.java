...
public class UsbTransferActivity extends AppCompatActivity {
    ...
    private void prepareTransfer() {
        tvStatus.setText(R.string.preparing_transfer);
        tvUsbVersion.setText(usbVersion != null ? usbVersion : "USB 2.0");
        tvMaxSpeed.setText(getString(R.string.usb_max_speed, maxSpeed));
        tvFileCount.setText(getString(R.string.files_progress, 0, fileCount));
    ...
    private void startTransfer() {
        if (transferFiles.isEmpty()) {
            tvStatus.setText(R.string.no_files_to_transfer);
            return;
        }

        isTransferring = true;
        startTime = System.currentTimeMillis();
        tvStatus.setText(R.string.transferring_now);
        tvTransferStatus.setText(R.string.transferring_now);
    ...
    private void transferFile(TransferFileItem item) throws Exception {
        ...
        mainHandler.post(() -> {
            tvCurrentFile.setText(getString(R.string.current_file_fmt, item.name));
            adapter.notifyDataSetChanged();
        });
    ...
    private void updateUI() {
        ...
        tvFileCount.setText(getString(R.string.files_progress, completedFiles, fileCount));
    ...
    private void onTransferComplete() {
        stopTransfer();
        tvStatus.setText(R.string.transfer_complete);
        tvTransferStatus.setText(R.string.all_files_transferred);
    ...
    private void onTransferError(Exception e) {
        stopTransfer();
        tvStatus.setText(R.string.transfer_failed);
        tvTransferStatus.setText(getString(R.string.transfer_failed_detail, e.getMessage()));
        Log.e(TAG, "传输失败", e);
    }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch (item.status) {
                ...
                case TRANSFERRING:
                    ...
                    break;
                case COMPLETED:
                    holder.tvFileStatus.setText(R.string.status_completed);
                    holder.tvFileStatus.setTextColor(getColor(R.color.success));
                    holder.progressBarFile.setVisibility(View.GONE);
                    break;
                case FAILED:
                    holder.tvFileStatus.setText(R.string.failed);
