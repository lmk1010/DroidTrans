...
public class SpeedTestActivity extends AppCompatActivity {
    ...
    private void runBench(String url, TextView tvResult, MaterialButton btn) {
        ...
        try {
            ...
            log.append("自动选择: ").append(auto.protocol.label).append("\n\n");
            ...
            for (TransferProtocol protocol : protocols) {
                ...
                log.append("开始 ").append(protocol.label).append(" …\n");
                post(tvResult, log.toString());
                ...
                log.append(String.format("  %s  %.2f 秒  %.1f MB/s\n\n", protocol.label, sec, mbps));
                post(tvResult, log.toString());
            }
        } catch (Exception e) {
            log.append("失败: ").append(e.getMessage()).append("\n");
            post(tvResult, log.toString());
        }
